      ...
      return new Scaffold(
        ...
        body: StreamBuilder(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                print("exist");
                if(snapshot.data.documents[0]['lastLocation']['latitude']!= null && snapshot.data.documents[0]['lastLocation']['longitude']!=null)
                  guide_position = new LatLng(snapshot.data.documents[0]['lastLocation']['latitude'],snapshot.data.documents[0]['lastLocation']['longitude']);
              } else {
                ...
                children: [
                  Padding(
                    ...
                    child: _serviceError.isEmpty
                        ...
                        '(${currentLatLng.latitude}, ${currentLatLng
                        .longitude}).')
                        : Text(
                        'Error occured while acquiring location: '
                    ),
                  ),
                  Flexible(
                    child: FlutterMap(
